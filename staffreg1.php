...
<input type="tel" name="MNum" id="mnum" placeholder="Enter your Mobile Number" required><br><br>
...
<input type="password" name="pwd1" id="name" placeholder="Enter confirmation password" required><br><br>
<input type="submit" name = "submit1" id="sub" value="Register">
</body>
<br>
<br>
<br>
